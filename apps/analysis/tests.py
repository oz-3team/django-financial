...
class AnalysisCRUDTests(TestCase):
    @classmethod
    ...
    def test_read(self):
        ...
        self.assertEqual(obj.pk, self.analysis.pk)
    ...
    def test_delete(self):
        ...
        self.assertFalse(self.AnalysisModel.objects.filter(pk=pk).exists())
...
class AnalysisAdminSmokeTests(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.User = get_user_model()
    ...
    def test_admin_pages(self):
        if self.AnalysisModel not in admin.site._registry:
...
class AnalysisServicesSmokeTests(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.module = _maybe_import("analysis.services")
